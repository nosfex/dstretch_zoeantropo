...
path_dir = glob.glob(str(pathlib.Path(__file__).parent.absolute()) + '/testfiles/*.jpg')
for k in path_dir:
    ...
    plt.show()
#preprocessing(cv2.imread(str(pathlib.Path(__file__).parent.absolute()) + '/testfiles/' + 'IMG_3949.JPG'))